...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TVQ3_0] = {
        .type_name                = "tvq3_0",
        .blck_size                = QK_TVQ,
        .type_size                = sizeof(block_tvq3_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tvq3_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tvq3_0_ref,
    },
    [GGML_TYPE_TVQ4_0] = {
        .type_name                = "tvq4_0",
        .blck_size                = QK_TVQ,
        .type_size                = sizeof(block_tvq4_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tvq4_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tvq4_0_ref,
    },
};
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_TVQ3_0:   result = quantize_tvq3_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_TVQ4_0:   result = quantize_tvq4_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
